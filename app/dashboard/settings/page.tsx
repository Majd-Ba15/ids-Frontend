        ...
        <CardContent className="space-y-4">
          <div className="flex items-center justify-between">
            <div className="space-y-0.5">
              ...
              <p className="text-sm text-muted-foreground">Receive updates about your courses via email</p>
            </div>
          ...
          <div className="flex items-center justify-between">
            ...
            <Switch id="courseReminders" checked={courseReminders} onCheckedChange={setCourseReminders} />
          </div>
        </CardContent>
      </Card>
    </div>
